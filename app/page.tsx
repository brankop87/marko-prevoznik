        ...
        <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-white/10 to-white/5 p-6">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            {[
              ...
              {
                n: "2",
                t: "Dogovorimo cenu i vreme dolaska",
                d: "Brza procena prema vozilu i relaciji.",
              },
              {
                n: "3",
      ...
      <footer className="border-t border-white/10 bg-black/30 pb-24 pt-8 sm:pb-8">
        ...
        <div className="mx-auto mt-4 flex max-w-5xl justify-start px-4">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="relative z-10 inline-flex rounded-md px-2 py-2 text-[11px] uppercase tracking-[0.22em] text-white/45 underline-offset-4 transition hover:text-white/70 hover:underline"
          >
